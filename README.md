...
En fait ce n'est pas qu'un simple KVM (Keyboard, Video, Mouse) pour *piloter* une machine en remote depuis son browser, mais un KVMNC  !
...
* Network, émulation d'une carte réseau USB sur la machine remote
* CDROM, émultation d'un CDROM sur la machine remote

Mais quand on utilise, sur la machine remote où est branché le nano KVM (via la prise USB), l'émulation de la carte réseau n'est *connectée* que entre le nano KVM et la machine remote.<br>
...
On peut *descendre* et *exécuter* le script sur le nano KVM directement avec l'icone *Script* en haut du nano KVM !

Après, il ne faudra pas oublier de refaire la connexion réseau au niveau de la machine remote pour qu'elle mette à jour l'adresse du *default gateway* et du *DNS*.
